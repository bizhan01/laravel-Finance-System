...
<head>
	...
	<body class="fixed-sidebar fixed-header skin-default">
		...
		<script type="text/javascript" src="{{ asset('js/forms-masks.js') }}"></script>
	  <script type="text/javascript" src="{{ asset('../vendors/bootstrap-inputmask/bootstrap-inputmask.min.js') }}"></script>
  	<script type="text/javascript" src="{{ asset('../vendors/autoNumeric/autoNumeric-min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('../vendors/chartist/chartist.min.js') }}"></script>
